...
namespace CNTK
{
    ...
    public:
        ...
        ///
        CNTK_API virtual Dictionary Serialize() const override { NOT_IMPLEMENTED; }
    ...
    public:
        ...
        ///
        CNTK_API static void RegisterUDFDeserializeCallback(const std::wstring& uniqueOpName, const UDFDeserializeCallbackPtr& deserializer);
