...
def _serialize(udf):
    dictionary = {}
    dictionary['class'] = udf.class_name
    dictionary['module'] = udf.module_name
    dictionary['deserialize_method'] = udf.deserialize_method_name
...
class _UDFDeserializeCallbackWrapper(cntk_py.UDFDeserializeCallbackWrapper):
    ...
    def __call__(self, inputs, name, dictionary):
        ...
        deserialize_method = dictionary.get('deserialize_method', 'deserialize')
