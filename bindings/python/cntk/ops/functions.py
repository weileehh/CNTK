...
class UserFunction(Function):
    ...
    def module_name(self):
        '''
        Name of the module that contains this function (can be overridden).
        '''
        return self.__class__._module_name()

    @property
    def class_name(self):
        '''
        Class name of the function (can be overridden).
        '''
        return self.__class__._class_name()

    @property
    def deserialize_method_name(self):
        '''
        Name of the static method that can be invoked to deserialize the function
        Defaults to 'deserialize', but can be overridden.
        '''
        return 'deserialize'
    ...
    @classmethod
    def _op_name(cls):
        return cls._module_name() + '.' + cls._class_name()
